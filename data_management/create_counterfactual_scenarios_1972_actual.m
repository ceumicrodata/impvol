function create_counterfactual_scenarios_1972_actual
...
for i = 1:(steps + 1)      
    scenario = sprintf('%.1f * 1972 costs   +   %.1f * actual costs', gamma(i), 1 - gamma(i));
    scenarioId = i;
    
    kappa_actual_step = gamma(i) * kappaInitial + (1 - gamma(i)) * kappa;
