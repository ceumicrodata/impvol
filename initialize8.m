...
c.dampeningLaborLoop = 0.7;
c.dampeningWageLoop = 0.3:-0.05:0.2;
c.dampeningPriceLoop = 0.7:-0.05:0.1;

% Technical values for the outer loop
c.outer_dif = 1e9; % a big number
c.outer_tol = 1e-5; % set the convergence tolerance
...
c.middle_tol = 1e-5; % set the convergence tolerance
...
c.inner_tol = 1e-5; % set the convergence tolerance
