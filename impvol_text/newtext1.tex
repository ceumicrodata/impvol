...
To compute volatility in the data, we measure real GDP as the nominal value
...
optimal expenditure-based price index $P_{nt}$. 

Burstein and Cravino (2015, Proposition 2) show that, up to a 
first approximation, changes in the CPI index and the optimal price index
will coincide. Hence real GDP in the model and data will be comparable
objects.\footnote{In this regard, our mapping will not be susceptible to Kehoe and Ruhl
